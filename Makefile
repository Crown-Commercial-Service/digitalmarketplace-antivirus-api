...
.PHONY: build
build:
	docker build -t digitalmarketplace-aws-antivirus-api-http --build-arg DM_APP_NAME=antivirus-api -f docker-aws/Dockerfile.http .
	docker build -t digitalmarketplace-aws-antivirus-api-wsgi -f docker-aws/Dockerfile.wsgi .
